...
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF (enter actual year, or values of 0 or -integer to be rel. endyr)
 0 0 0 0 245 256
#  256 256 256 256 245 256 # after processing 
...
#_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF  (enter actual year, or values of 0 or -integer to be rel. endyr)
 0 0 0 0
#  1413960770 1918989407 7628135 115 # after processing 
...
1918987586 #_N forecast loops (1=OFL only; 2=ABC; 3=get F from forecast ABC catch with allocations applied)
1918459755 #_First forecast loop with stochastic recruitment
6582879 #_Forecast loop control #3 (reserved for future bells&whistles) 
97 #_Forecast loop control #4 (reserved for future bells&whistles) 
...
#_Fleet:  fishing_gi_1 fishing_gi_4 fishing_hd_1 fishing_ll_1 fishing_ll_2 fishing_ll_3 fishing_ll_4 fishing_other_1 fishing_other_4 fishing_bb_1 fishing_ps_1 fishing_ps_2 fishing_ps_4 fishing_trol_1 fishing_trol_2 fishing_trol_4
